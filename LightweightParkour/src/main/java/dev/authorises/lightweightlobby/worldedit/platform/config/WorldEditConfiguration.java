package dev.authorises.lightweightlobby.worldedit.platform.config;
...
public class WorldEditConfiguration extends LocalConfiguration {
    ...
    @Override
    public void load() {
        this.defaultLocale=Locale.FRENCH;
        this.defaultChangeLimit=500000;
        this.extendedYLimit=true;
        this.maxBrushRadius=20;
    }
    /*@Unreported
    @Nullable
