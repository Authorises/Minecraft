...
public class signShopItem implements ShopItem {
    ...
    public @NotNull ItemStack getDispayItem() {
        return new ItemBuilder(getMaterial())
                .setComponentName(Cavelet.miniMessage.deserialize("<!italic><#9eb5db>Sign"))
    ...
    public void purchase(Player p, double amt) {
        ...
        while (amt > 0){
            p.getInventory().addItem(new ItemStack(Material.WARPED_SIGN));
            amt-=1;
        }
    }
