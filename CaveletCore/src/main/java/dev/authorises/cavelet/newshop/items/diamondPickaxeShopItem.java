...
public class diamondPickaxeShopItem implements ShopItem {

    @Override
    public @NotNull String displayName() {
        return "&bDiamond Pickaxe";
    }
    ...
    public @NotNull ItemStack getDispayItem() {
        return new ItemBuilder(getMaterial())
                .setComponentName(Cavelet.miniMessage.deserialize("<!italic><#9eb5db>Diamond Pickaxe"))
    ...
    public void purchase(Player p, double amt) {
        ...
        CItem cItem = new CItem(Cavelet.customItemsManager.getItemById("DIAMOND_PICKAXE"));
