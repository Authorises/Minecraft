...
public class seedsShopItem implements ShopItem {
    ...
    public @NotNull ItemStack getDispayItem() {
        return new ItemBuilder(getMaterial())
                .setComponentName(Cavelet.miniMessage.deserialize("<!italic><#9eb5db>Seeds"))
    ...
    public void purchase(Player p, double amt) {
        ...
        while (amt > 0){
            p.getInventory().addItem(new ItemStack(Material.WHEAT_SEEDS));
            amt-=1;
        }
    }
