...
public class trapdoorShopItem implements ShopItem {
    ...
    public @NotNull ItemStack getDispayItem() {
        return new ItemBuilder(getMaterial())
                .setComponentName(Cavelet.miniMessage.deserialize("<!italic><#9eb5db>Trapdoor"))
    ...
    public void purchase(Player p, double amt) {
        ...
        while (amt > 0){
            p.getInventory().addItem(new ItemStack(Material.WARPED_TRAPDOOR));
            amt-=1;
        }
    }
