...
public class diamondShovelShopItem implements ShopItem {

    @Override
    public @NotNull String displayName() {
        return "&bDiamond Shovel";
    }
    ...
    public @NotNull ItemStack getDispayItem() {
        return new ItemBuilder(getMaterial())
                .setComponentName(Cavelet.miniMessage.deserialize("<!italic><#9eb5db>Diamond Shovel"))
    ...
    public void purchase(Player p, double amt) {
        ...
        CItem cItem = new CItem(Cavelet.customItemsManager.getItemById("DIAMOND_SHOVEL"));
    ...
    public @NotNull ArrayList<ShopCategory> getCategories() {
        ...
        categories.add(ShopCategory.FARMING);
