...
public class breadShopItem implements ShopItem {
    ...
    public @NotNull ItemStack getDispayItem() {
        return new ItemBuilder(getMaterial())
                .setComponentName(Cavelet.miniMessage.deserialize("<!italic><#9eb5db>Bread"))
    ...
    public void purchase(Player p, double amt) {
        ...
        CItem cItem = new CItem(Cavelet.customItemsManager.getItemById("BREAD"));
