...
public class diamondSwordShopItem implements ShopItem {

    @Override
    public @NotNull String displayName() {
        return "&bDiamond Sword";
    }
    ...
    public @NotNull ItemStack getDispayItem() {
        return new ItemBuilder(getMaterial())
                .setComponentName(Cavelet.miniMessage.deserialize("<!italic><#9eb5db>Diamond Sword"))
    ...
    public void purchase(Player p, double amt) {
        ...
        CItem cItem = new CItem(Cavelet.customItemsManager.getItemById("DIAMOND_SWORD"));
