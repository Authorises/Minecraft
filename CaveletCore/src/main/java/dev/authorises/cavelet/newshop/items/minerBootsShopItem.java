...
public class minerBootsShopItem implements ShopItem {
    ...
    public @NotNull ItemStack getDispayItem() {
        return new ItemBuilder(new CItem(Cavelet.customItemsManager.getItemById("MINER_BOOTS")).getItemStack())
                .setComponentName(Cavelet.miniMessage.deserialize("<!italic><#9eb5db>Miner Boots"))
    ...
    public void purchase(Player p, double amt) {
        ...
        CItem cItem = new CItem(Cavelet.customItemsManager.getItemById("MINER_BOOTS"));
