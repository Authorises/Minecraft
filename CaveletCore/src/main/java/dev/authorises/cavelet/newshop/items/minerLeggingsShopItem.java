...
public class minerLeggingsShopItem implements ShopItem {

    @Override
    public @NotNull String displayName() {
        return "&bMiner Leggings";
    }
    ...
    public @NotNull ItemStack getDispayItem() {
        return new ItemBuilder(new CItem(Cavelet.customItemsManager.getItemById("MINER_LEGGINGS")).getItemStack())
                .setComponentName(Cavelet.miniMessage.deserialize("<!italic><#9eb5db>Miner Leggings"))
    ...
    public void purchase(Player p, double amt) {
        ...
        CItem cItem = new CItem(Cavelet.customItemsManager.getItemById("MINER_LEGGINGS"));
