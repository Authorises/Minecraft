...
public class minerChestplateShopItem implements ShopItem {

    @Override
    public @NotNull String displayName() {
        return "&bMiner Chestplate";
    }
    ...
    public @NotNull ItemStack getDispayItem() {
        return new ItemBuilder(new CItem(Cavelet.customItemsManager.getItemById("MINER_CHESTPLATE")).getItemStack())
                .setComponentName(Cavelet.miniMessage.deserialize("<!italic><#9eb5db>Miner Chestplate"))
    ...
    public void purchase(Player p, double amt) {
        ...
        CItem cItem = new CItem(Cavelet.customItemsManager.getItemById("MINER_CHESTPLATE"));
